...
if model_type == 'latent_clstm':
    ...
    prior_config = {'latent_size': [latent_dim, 64, 64],
    ...
    approx_post_config = {'dist_config': {'dist_type': 'Normal',
                                          ...
                                          'base_scale_type': {'type': 'convolutional',
                                                                      ...
                                                                      'connectivity': 'sequential',
                                                                      'last_linear': True}},
                          'spatial_network_config': {'inputs': ['x', 'z'],
                                                      'type': 'conv_recurrent',
                                                      'n_layers': 2,
                                                      'input_size': 64,
                                                      'n_units': [64, 64],
...
# use conv-lstm for generating latent distiribution for noise
if model_type == 'latent_flow_clstm':
    latent_dim = 32
    ...
    cond_like_config = {'dist_config': {'dist_type': 'AutoregressiveFlow',
                         ...
                         'spatial_network_config': {'inputs': ['z', 's'],
                                                    'type': 'conv_recurrent',
                                                    'n_layers': 2,
                                                    'input_size': 64,
                                                    'n_units': [64, 64],
    ...
    approx_post_config = {'dist_config': {'dist_type': 'Normal',
                                          ...
                                          'base_scale_type': {'type': 'convolutional',
                                                                      ...
                                                                      'connectivity': 'sequential',
                                                                      'last_linear': True}},
                          'spatial_network_config': {'inputs': ['y', 'z'],
                                                      'type': 'conv_recurrent',
                                                      'n_layers': 2,
                                                      'input_size': 64,
                                                      'n_units': [64, 64],
...
if model_type == 'planet_flow':
    ...
    prior_config = {'latent_size': [latent_dim],
                    'dist_config': {'dist_type': 'Normal',
                                    'n_variables': [latent_dim],
                                    'base_loc_type': {'type': 'fully_connected',
                                                              'n_layers': 1,
    ...
    approx_post_config = {'dist_config': {'dist_type': 'Normal',
                                          ...
                                          'base_scale_type': {'type': 'fully_connected',
                                                                      'n_layers': 1,
                                                                      'n_units': latent_dim}},
                          'spatial_network_config': {'inputs': ['y', 's'],
                                                      'type': 'planet_encoder'},
                          'temporal_network_config': None
                          }
...
if model_type == 'planet':
    ...
    approx_post_config = {'dist_config': {'dist_type': 'Normal',
                                          ...
                                          'base_scale_type': {'type': 'fully_connected',
                                                                      'n_layers': 1,
                                                                      'n_units': latent_dim}},
                          'spatial_network_config': {'inputs': ['x', 's'],
                                                      'type': 'planet_encoder'},
                          'temporal_network_config': None
                          }
